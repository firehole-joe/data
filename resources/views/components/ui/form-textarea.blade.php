...
@php
    $id = $id ?? $name ?? 'textarea-' . \Illuminate\Support\Str::random(6);
@endphp
    ...
    @if ($label)
        <label
            ...
            class="pointer-events-none absolute left-3 top-1.5 text-[10px] font-semibold uppercase tracking-wider text-ink-subtle transition-all
                   peer-placeholder-shown:top-3 peer-placeholder-shown:text-[13px] peer-placeholder-shown:font-normal peer-placeholder-shown:normal-case peer-placeholder-shown:tracking-normal
